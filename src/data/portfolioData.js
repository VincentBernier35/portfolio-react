export const portfolioData = [
  {
    id: 1,
    name: 'Portfolio perso n°1',
    languages: ['javascript','css'],
    languagesIcons: ['fab fa-js','fab fa-css3-alt'],
    source: 'https://github.com/VincentBernier35/portfolio',
    info: "C'est un portfolio que j'ai réalisé en vanilla Javascript et HTML/CSS",
    picture: './media/portfolioJsVanilla.png'
  },
  {
    id: 2,
    name: 'lorem.fr',
